# Mini Game Collection - Portfolio Project

## 📌 Project Overview

**Blazor WebAssembly 기반 미니게임 컬렉션**

6 개의 독립적인 미니게임을 포함하며, SOLID 원칙과 DI 를 준수한 순수 C# Core 게임 로직으로 구성된 포트폴리오 프로젝트입니다.

### 🔗 Links

- **Live Demo**: [Vercel 배포 URL] (배포 후 추가)
- **GitHub Repository**: https://github.com/kongnamul-muchim/MiniGameCollection
- **Tech Stack**: Blazor WebAssembly, .NET 8.0, C#
